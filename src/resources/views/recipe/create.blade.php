            ...
            <form method="post" action="{{route('recipe.store')}}" enctype="multipart/form-data">
                ...
                <div class="md:flex items-center mt-8">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" name="dish_name"
                            ...
                            value="{{old('dish_name')}}" style="margin-top: 4px;">
                    </div>
                </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="food" class="w-auto py-2 border border-gray-300 rounded-md" id="food" cols="30"
                        rows="5" style="margin-top: 4px;">{{old('food')}}</textarea>
                </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="how_to_make" class="w-auto py-2 border border-gray-300 rounded-md" id="how_to_make"
                        cols="30" rows="10" style="margin-top: 4px;">{{old('how_to_make')}}</textarea>
                </div>
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="tags"
                        ...
                        value="{{old('tags')}}" style="margin-top: 4px;">
                </div>
                <div class="w-full flex flex-col">
